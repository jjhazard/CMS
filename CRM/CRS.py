...
#Database
from FileOp import FileOpen, FileMod
...
####################################
#Paths
folderPath = '/home/pi/CRM/CRSCodes/'
...
class Communicate(FileOpen):
    def __init__(self, code):
        self.code = code
        super().__init__('/home/pi/CRM/CommPlaceholder/comms', 'a')
    def execute(self):
        self.file.write(self.code)
        self.close()
...
def generate():
    ...
    print("Acquired code " + code) #replace with printer call
